    ...
    <section id="contact" className="contact-section">
      ...
      >
        ...
        <div className="contact-actions">
          ...
          <a href={personal.whatsapp} target="_blank" rel="noreferrer" className="btn btn-primary" style={{background:'#25D366'}}>
            <WhatsAppIcon /> WhatsApp
          </a>
          <a href={personal.github} target="_blank" rel="noreferrer" className="btn btn-outline">
            <GithubIcon /> GitHub
          </a>
          <a href={personal.twitter} target="_blank" rel="noreferrer" className="btn btn-outline">
            <XIcon /> @Meethybrid_
          </a>
        </div>
